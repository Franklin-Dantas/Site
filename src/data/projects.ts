    ...
    ai: [
        {
            ...
            description: '2º lugar no Hackathon da NASA com automação de coleta e visualização de dados espaciais.',
            tags: ['Python', 'Selenium', 'APIs', 'Automação'],
            featured: true,
        },
        {
            image: analyticsImg,
            title: 'Web Scraping Bot',
            description: 'Bot automatizado para coleta de dados em múltiplas fontes com agendamento e notificações.',
            tags: ['Python', 'Puppeteer', 'Cron Jobs', 'APIs'],
            featured: true,
        },
        {
            image: conectaImg,
            title: 'Task Automation Suite',
            description: 'Conjunto de scripts para automação de tarefas repetitivas e integração entre sistemas.',
            tags: ['Python', 'Bash', 'GitHub Actions', 'Scripting'],
            featured: false,
        },
    ],
};
